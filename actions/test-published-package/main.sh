...
LLAMA_STACK_TEST_INTERVAL_SECONDS=3 pytest -s -v tests/integration/ \
  ...
  -k "not(supervised_fine_tune or builtin_tool_code or safety_with_image or code_interpreter_for or rag_and_code or truncation or register_and_unregister or test_files)" \
